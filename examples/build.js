...
window.facebook = _index2.default;
...
var FBCallback = {
    _callback: function _callback(callback, newProps) {
        this.result = _lodash2.default.extend(this.result, newProps || {});
    ...
    init: function init(params, callback) {
        ...
        promises.init(params).then(function (response) {
            ...
            _this._callback(callback, { loading: false, status: 'unknown', error: error });
            console.warn(error);
        });
    },
